  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      { opacity: 0, scale: 0, rotation: -160, borderRadius: "100%" },
      {
        ...
        onUpdate: function () {
          ...
          if (width >= 484 && width <= 1280) {
            gsap.set(".image", { borderRadius: "50px" });
          } else if (width < 484) {
            gsap.set(".image", { borderRadius: "23px" });
          }
        },
      }
    );
      ...
      { scale: 0, opacity: 0, filter: "blur(10px)", borderRadius: "100%" },
      {
        ...
        onUpdate: function () {
          ...
          if (width >= 484 && width <= 1280) {
            ...
            gsap.set(".zoom-out", { borderRadius: "23px" });
          }
    ...
    gsap.fromTo(
      ...
      onUpdate: function () {
        ...
        gsap.set(".rotate-x", { borderRadius: "23px" });
        }
      },
      }
    );
      ...
      <div className="text-white md:h-[750px] lg:h-[813px] xl:h-[950px] hero-section  mt-3 overflow-hidden relative -z-50 md:flex">
        ...
        <div className="md:w-[45%] w-[100%] overflow-hidden">
          <div className="flex flex-col gap-3 mt-20 2xl:ml-[4rem] xl:ml-20 md:ml-8 xs:ml-6">
            ...
            <h1 className="font-raleway font-medium xs:text-[20px] sm:text-[25px] md:text-[25px] lg:text-[35px] 2xl:text-[48px] xl:text-[40px]">
              Delivering Excellence in{" "}
            </h1>
            <div className="scroller font-faustina font-semibold xs:text-[37px] sm:text-[48px] md:text-[50px] lg:text-[65px] 2xl:text-[90px] xl:text-[77px]">
              <span>
                IT Consulting
                <br />
                Wellness
