    ...
    <>
      <div className="mt-10">
        ...
        <div className="flex flex-col xs:flex-row md:flex-row justify-center items-center relative md:py-12 lg:py-16">
          <div className="w-[90%] md:w-[80%] h-full md:h-[62%] absolute  div-2-mini z-10"></div>
          <div className="div-1 w-full 2xl:w-[36%]  xl:w-[20%]  md:w-[10%] lg:w-[15%]  xs:w-1/5 flex mb-4 md:mb-0">
          ...
          <div className="w-full 2xl:w-[36%] xl:w-[20%] lg:w-[15%] md:w-[10%] xs:w-1/5 mt-4 md:mt-0">
